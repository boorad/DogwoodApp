...
const Alumni = props => {
  ...
  const trophy = <Icon name="trophy" size={24} color={'#666'} />;

  const blank = <Icon name="checkbox-blank" size={24} color={'#fff'} />;
  ...
  const title = (
    <View style={styles.title}>
      <Text style={styles.titleText}>Dogwood Alumni</Text>
      <Text style={styles.subTitleText}>Official World Golf Rankings</Text>
    </View>
  );
